...
if settingsExist == 2
    ...
    set(handles.integEbox, 'string', num2str(5))
    set(handles.timeinEbox, 'string', num2str(0.6))
    set(handles.stepEbox, 'string', num2str(1))
    set(handles.regionxminEbox, 'string', num2str(-160.1))
    set(handles.regionxmaxEbox, 'string', num2str(-150.1))
    set(handles.regionyminEbox, 'string', num2str(54.99))
    set(handles.regionymaxEbox, 'string', num2str(59.99))
    set(handles.meshxEbox, 'string', num2str(100))
    set(handles.meshyEbox, 'string', num2str(100))
    set(handles.startFEbox, 'string', num2str(1))
    set(handles.endFEbox, 'string', num2str(1))
